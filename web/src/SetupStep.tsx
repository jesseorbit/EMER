...
export default function SetupStep({ onComplete }: Props) {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* 스크롤 영역 */}
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 pt-12">
        {/* 헤더 */}
        <motion.div
        ...
        {names.length < 8 && (
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            onClick={addPerson}
            className="mt-2.5 w-full py-3 rounded-xl border-2 border-dashed border-toss-gray-200
        ...
        <p className="text-[13px] text-toss-gray-400 mt-2 pb-4">
          {names.length}명 참가
          {hasDuplicates && (
